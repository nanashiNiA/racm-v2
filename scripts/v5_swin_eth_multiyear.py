"""V5: swin_v25 ETH multi-year (2022, 2024, 2025)
==================================================
ETH cache 完成済み。3年分一気にテスト。
"""
...
print('='*70,flush=True)
print('  V5: swin_v25 ETH multi-year',flush=True)
print('='*70,flush=True)
